...
def main():
    ...
    parser.add_argument('-proj_height', type=int, default=1080, help='projector pixel height')
    parser.add_argument('-proj_width', type=int, default=1920, help='projector pixel width')
    parser.add_argument('-graycode_step', type=int, default=16, help='step size of graycode [default:1](increase if moire appears)')
